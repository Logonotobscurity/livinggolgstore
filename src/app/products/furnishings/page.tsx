...
export default function FurnishingsPage() {
  const products = PlaceHolderImages.filter(p => p.id.startsWith('furnishings-') && p.id !== 'furnishings-hero');
  const heroImage = PlaceHolderImages.find(p => p.id === 'furnishings-hero');
