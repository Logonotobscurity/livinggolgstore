  ...
  return (
    <CmsLayout breadcrumb={breadcrumb}>
      <div className="cms-page text-foreground">
        ...
        {/* Hero Section */}
        <section className={`relative flex items-center bg-secondary/20 ${isMobile ? 'min-h-[60vh] py-16' : 'min-h-[70vh]'}`}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-12 md:gap-8 items-center">
              <div className={`relative w-full ${isMobile ? 'h-80' : 'h-[500px]'} rounded-lg overflow-hidden`}>
                  <Image 
