    ...
    <CmsLayout breadcrumb={breadcrumb}>
      <div className="cms-page text-foreground">
        ...
        <div className="text-wrapper text-center my-16 md:my-24">
          <p className={`${isMobile ? 'text-base' : 'text-lg'} max-w-3xl mx-auto`}>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <h2 className="font-headline text-4xl md:text-5xl font-bold text-center mb-16">Our Services</h2>
            <div className="grid md:grid-cols-2 gap-x-12 gap-y-16">
                {services.map(service => (
                    <div key={service.title} className="flex flex-col sm:flex-row items-start text-center sm:text-left gap-6">
                        <div className="mx-auto sm:mx-0">{service.icon}</div>
                        <div>
        ...
        <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <h2 className="font-headline text-4xl md:text-5xl font-bold text-center mb-20">Our Process</h2>
            <div className="relative grid grid-cols-1 md:grid-cols-4 gap-8">
                 <div className="absolute top-1/2 left-0 w-full h-px bg-primary/20 hidden md:block" />
                 {processSteps.map(step => (
                    <div key={step.step} className="relative flex flex-col items-center text-center">
                        <div className="absolute -top-10 h-8 w-px bg-primary/20 md:hidden" />
        ...
        <section className="bg-secondary/50 py-20 md:py-24 mt-16">
            <div className="container mx-auto px-4 text-center">
                <h2 className="font-headline text-3xl md:text-4xl font-bold mb-4">Let's Create Something Beautiful</h2>
