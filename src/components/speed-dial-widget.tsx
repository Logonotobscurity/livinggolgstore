...
// Add custom icons to the Icons object when missing
...
// Sparkles icon for closed state
;(Icons as any).sparkles = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
    ...
    {...props}
  >
    <path d="M5 3l1.5 3L10 7l-3.5 1L5 11 3.5 8 0 7l3.5-1L5 3z" transform="translate(3 2)" />
    <path d="M14 9l.8 1.6L17 11l-2.2.4L14 13l-.8-1.6L11 11l2.2-.4L14 9z" />
    <path d="M18 3l.8 1.6L21 5l-2.2.4L18 7l-.8-1.6L15 5l2.2-.4L18 3z" />
  </svg>
);

// X icon for open state
;(Icons as any).xClose = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
